...
class ControllerCommonCart extends Controller {
	public function index() {
		...
		$data['text_sum'] = sprintf($this->language->get('text_sum'), $this->currency->format($total));
		$data['text_loading'] = $this->language->get('text_loading');
		$data['text_itemsprev'] = $this->language->get('text_itemsprev');
		$data['text_sumprev'] =	$this->language->get('text_sumprev');
