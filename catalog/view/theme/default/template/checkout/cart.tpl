...
<div class="container animations_our">
  <?php if ($attention) { ?>
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?> cart-page"><?php echo $content_top; ?>
...
<!--       <div class="row">
      ...
      <div class="buttons col-xs-12 col-md-6 pull-right" style="margin-bottom: 60px;">
        <div class="col-xs-12 col-md-6 shopping"><a href="<?php echo $continue; ?>"  class="btn-shopping"><?php echo $button_shopping; ?></a></div>
        <div class="col-xs-12 col-md-6 checkout"><a href="<?php echo $checkout; ?>" class="btn-checkout"><?php echo $button_checkout; ?></a></div>
      </div> 
