...
class ControllerProductProduct extends Controller {
	...
	public function index() {
			...
			foreach ($parts as $path_id) {
				...
				if ($category_info) {
					$data['breadcrumbs'][] = array(
						...
						'href' => $this->url->link('product/category2', 'path=' . $path)
					);
				}
			}
		...
		if ($product_info) {
			...
			$data['text_option_size'] = $this->language->get('text_option_size');
			...
			$data['text_show_price'] = $this->language->get('text_show_price');
			$data['text_show_price_opt'] = $this->language->get('text_show_price_opt');

			$data['text_prev_name'] =$this->language->get('text_prev_name');
			$data['text_whith_photo'] =$this->language->get('text_whith_photo');
			$data['request_current_price'] =$this->language->get('request_current_price');
			$data['text_name'] = sprintf($this->language->get('text_name'),$this->customer->getFirstName(), $this->customer->getLastName());


			$data['text_wait_for'] =$this->language->get('text_wait_for');
...
////////////////////////////////////////////////////////////////////////////////////////////////
			...
			// 	$data['zoom'] = $this->model_tool_image->resize($product_info['image'], $this->config->get('config_image_popup_width')*2, $this->config->get('config_image_popup_height')*2);
			// } else {
			// 	$data['zoom'] = '';
			// }
			...
			// 	$data['images'][] = array(
			// 		'zoom' => $this->model_tool_image->resize($result['image'], $this->config->get('config_image_popup_width')*3, $this->config->get('config_image_popup_height')*3),
