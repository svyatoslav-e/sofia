...
class ControllerSaleOrder extends Controller {
	...
	public function getForm() {
        ...
        'value'              => ($custom_field['value']==="")?'ND':$custom_field['value'],
	...
	public function info() {
		...
		if ($order_info) {
			...
			$replace = array(
				...
				'address_1' => ($order_info['payment_address_1']==='')?'ND':$order_info['payment_address_1'],
        ...
        'address_1' => ($order_info['shipping_address_1']==='')?'N/D':$order_info['shipping_address_1'],
				...
				if ($custom_field['location'] == 'address' && isset($order_info['payment_custom_field'][$custom_field['custom_field_id']])) {
					if ($custom_field['type'] == 'select' || $custom_field['type'] == 'radio') {
						...
						if ($custom_field_value_info) {
							$data['payment_custom_fields'][] = array(
								'name'  => $custom_field['name'],
								'value' => ($custom_field_value_info['name']==='')?'N/D':$custom_field_value_info['name'],
								'sort_order' => $custom_field['sort_order']
							);
						}
					}
