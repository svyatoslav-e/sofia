...
<div class="form-group">
                              <label class="col-sm-2 control-label" for="input-comment2"><span data-toggle="tooltip" title="<?php echo $help_comment; ?>"><?php echo $entry_comment; ?></span></label>
                              <div class="col-sm-10">
                                <textarea name="config_comment2" rows="5" placeholder="<?php echo $entry_comment; ?>" id="input-comment2" class="form-control"><?php echo $config_comment; ?></textarea>
              <script type="text/javascript">
