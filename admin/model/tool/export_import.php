...
//		}
		...
		try {
			...
			switch ($export_type) {
				...
				case 'p':
					...
					break;
				case 'o':
					$filename = 'options-'.$datetime.'.xls';
					break;
				case 'a':
					$filename = 'attributes-'.$datetime.'.xls';
					break;
				case 'f':
					if (!$this->existFilter()) {
						throw new Exception( $this->language->get( 'error_filter_not_supported' ) );
	...
	public function getNotifications() {
		...
		$result = $this->curl_get_contents("http://www.mhccorp.com/index.php?route=information/message&type=tool_export_import_3_8&language_code=$language_code");
