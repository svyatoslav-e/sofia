...
$_['text_option_size']         = 'Выберите размер:';
...
$_['text_no_reviews']          = 'Нет отзывов. Будьте первыми!';
...
$_['text_year']                = 'Год';
$_['text_price']                = 'Цена:';
$_['text_show_price']           = 'Узнать оптовую цену';

// $_['text_wait_for']             = 'Ожидайте подтверждения статуса оптового клиента!';
$_['text_wait_for']             = 'Дождитесь подтверждения регистрации!';
...
$_['error_text']               = 'Текст отзыва должен содержать от 10 до 1000 символов!';
$_['error_rating']             = 'Пожалуйста, выберите оценку!';


$_['text_price']               = 'Цена:';
$_['text_show_price']          = 'Узнать розничную цену';
$_['text_show_price_opt']      = 'Узнать оптовую цену';
$_['text_option_size']         = 'Выберите размер:';

$_['text_whith_photo']         = 'c фото';
$_['text_prev_name']           = 'ФИО: ';
$_['text_name']                = '%s %s';
$_['request_current_price']    = 'Запрос актуального прайс листа';