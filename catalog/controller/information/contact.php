...
class ControllerInformationContact extends Controller {
  ...
  public function index() {
    ...
    $data['mail_to_name'] = $this->config->get('config_email');
    ...
    $data['text_telephone_name'] = $this->language->get('text_telephone_name');
    $data['text_fax'] = $this->language->get('text_fax');
    $data['text_open'] = $this->language->get('text_open');

    $data['text_comment'] = $this->language->get('text_comment');
    $data['text_comment2'] = $this->language->get('text_comment2');
    // $data['text_comment2'] = $this->language->get('text_comment3');
    ...
    if (isset($this->error['name2'])) {
      $data['error_name2'] = $this->error['name2'];
    } else {
      $data['error_name2'] = '';
    }
    ...
    if (isset($this->error['enquiry2'])) {
      $data['error_enquiry2'] = $this->error['enquiry2'];
    } else {
      $data['error_enquiry2'] = '';
    }
    ...
    $data['comment2'] = html_entity_decode($this->config->get('config_comment2'), ENT_QUOTES, 'UTF-8');
    $data['comment3'] = html_entity_decode($this->config->get('config_comment3'), ENT_QUOTES, 'UTF-8');
  ...
  protected function validate() {
    ...
    if ((utf8_strlen($this->request->post['name']) < 3) || (utf8_strlen($this->request->post['name']) > 32)) {
      if($this->request->post['wholesale']=='true'){
        $this->error['name2'] = $this->language->get('error_name');
      } else {
    ...
    if (!preg_match('/^[^\@]+@.*.[a-z]{2,15}$/i', $this->request->post['email'])) {
      if($this->request->post['wholesale']=='true') {
        $this->error['email2'] = $this->language->get('error_email');
      } else {
    ...
    if ((utf8_strlen($this->request->post['enquiry']) < 10) || (utf8_strlen($this->request->post['enquiry']) > 3000)) {
      if($this->request->post['wholesale']=='true') {
        $this->error['enquiry2'] = $this->language->get('error_enquiry');
      } else {
