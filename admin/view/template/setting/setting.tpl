        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
                ...
                <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-comment2"><span data-toggle="tooltip" title="<?php echo $help_comment; ?>"><?php echo $entry_comment2; ?></span></label>
                              <div class="col-sm-10">
                                <textarea name="config_comment2" rows="5" placeholder="<?php echo $entry_comment; ?>" id="input-comment2" class="form-control"><?php echo $config_comment2; ?></textarea>
              <script type="text/javascript">
                                   CKEDITOR.replace('input-comment2');
               </script>
                              </div>
   </div>
<!-- RUSSIA OPT -->
                   <div class="form-group">
                              <label class="col-sm-2 control-label" for="input-comment3"><span data-toggle="tooltip" title="<?php echo $help_comment; ?>"><?php echo $entry_comment3; ?></span></label>
                              <div class="col-sm-10">
                                <textarea name="config_comment3" rows="5" placeholder="<?php echo $entry_comment; ?>" id="input-comment3" class="form-control"><?php echo $config_comment3; ?></textarea>
              <script type="text/javascript">
                                   CKEDITOR.replace('input-comment3');
               </script>
                              </div>
   </div>
   <!-- RUSSIA OPT -->
