          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-payment">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="address_1" value="<?php echo ($payment_address_1==='')?'N/D': $payment_address_1; ?>" id="input-payment-address-1" class="form-control" />
                </div>
              </div>
              <div class="form-group">
...
<!--                  <input type="text" name="address_1" value="--><?php //echo $shipping_address_1; ?><!--" id="input-shipping-address-1" class="form-control" />-->
                  <input type="text" name="address_1" value="<?php echo ($shipping_address_1==='')?'N/D': $shipping_address_1; ?>" id="input-shipping-address-1" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="city" value="<?php echo ($shipping_city==='')?'N/D':$shipping_city; ?>"
...
var shipping_zone_id = ('<?php echo $shipping_zone_id; ?>'!=='0')?'<?php echo $shipping_zone_id; ?>':'<?php echo
$payment_zone_id; ?>';
