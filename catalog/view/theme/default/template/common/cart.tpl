<div id="cart">
  <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-inverse btn-block btn-lg dropdown-toggle"><!-- <i class="fa fa-shopping-cart"></i> -->
    <span id="cart-items" class="cart-total"><span class="prev"><?php echo $text_itemsprev; ?></span><span><?php echo $text_items; ?></span></span>
    <span id="cart-total" class="cart-total"><span class="prev"><?php echo $text_sumprev; ?></span><span><?php echo $text_sum; ?></span></span>
  </button>
...
<script>
  ...
  $('#cart>button[data-toggle="dropdown"]').on('mousedown', function () {

 $('#cart>button[data-toggle="dropdown"]').css('outline','none');
    var style = $('#cart>button[data-toggle="dropdown"]').css('border-radius');
    $('#cart>button[data-toggle="dropdown"]').css('border-radius','0px');
    var style2 = $('#cart>button[data-toggle="dropdown"]').css('box-shadow');

    var style3 = $('#cart>button[data-toggle="dropdown"]').css('border-top');

// console.log(style, style2, style3);


   // $('#cart>button[data-toggle="dropdown"]').css('border', '0px');
  ...
  $('.dropdown-toggle').trigger('mousedown');
