        ...
        <div class="simplecheckout">
            <?php if (!$cart_empty) { ?>
                ...
                <div class="simplecheckout-button-block buttons" id="buttons">
                    <div class="simplecheckout-button-right col-xs-12 col-sm-6 col-md-6">
                        ...
                        <?php } ?>
                        <?php if (!$block_order) { ?>
                            <a class="btn-shopping-product" data-onclick="createOrder" id="simplecheckout_button_confirm"><span><?php echo $button_order; ?></span></a>
                        <?php } ?>
                    </div>
