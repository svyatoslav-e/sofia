...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_comment2'] = $this->language->get('entry_comment2');
		$data['entry_comment3'] = $this->language->get('entry_comment3');
	   ...
	   if (isset($this->request->post['config_comment2'])) {
			$data['config_comment2'] = $this->request->post['config_comment2'];
		} else {
			$data['config_comment2'] = $this->config->get('config_comment2');
		}

		 if (isset($this->request->post['config_comment3'])) {
			$data['config_comment3'] = $this->request->post['config_comment3'];
		} else {
			$data['config_comment3'] = $this->config->get('config_comment3');
		}
