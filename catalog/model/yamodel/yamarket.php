...
//        $s .= '<'.$tag.'>'."<![CDATA[".$val.']]>'.'</'.$tag.'>';
	...
	{
		$allowed = array('url', 'price', 'currencyId', 'categoryId', 'picture', 'store', 'pickup', 'delivery', 'name', 'vendor', 'vendorCode', 'description', 'sales_notes', 'downloadable', 'weight', 'dimensions', 'country', 'param', 'sales_notes', 'country_of_origin', 'description', 'group_id');
		$param = array();
