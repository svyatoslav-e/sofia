    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-module-custom-template" class="form-horizontal">
              ...
              <div class="form-group required stemplate module<?php echo $module_row ?> common<?php echo $module_row ?>">
                ...
                <div class="col-sm-10">
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"><?php echo $template_dir ?></span>
          ...
          <p>Вы так же можете поддержить разработку и обновление модуля:</p><br>
          <ul>
...
function addModule(){
  ...
  html += ' <?php echo $category_data['name']; ?>';
  html += '</label>';
  html += '</div>';
  <?php } ?>
  html += '</div>';
  ...
  html += ' <?php echo $information_data['title']; ?>';
  html += '</label>';
  html += '</div>';
  <?php } ?>
  html += '</div>';
  ...
  html += ' <?php echo $manufacturer_data['name']; ?>';
  html += '</label>';
  html += '</div>';
  <?php } ?>
  html += '</div>';
 html += '<a onclick="$(this).parent().find(\':checkbox\').prop(\'checked\', true);"><?php echo $text_select_all; ?></a> / <a onclick="$(this).parent().find(\':checkbox\').prop(\'checked\', false);"><?php echo $text_unselect_all; ?></a>';
  ...
  html += '<span class="input-group-addon" id="basic-addon1"><?php echo $js_template_dir ?></span>';
